...
(function () {
  ...
  if (toTop) {
    var onTT = function () { toTop.classList.toggle('show', window.scrollY > window.innerHeight * 1.4); };
    window.addEventListener('scroll', onTT, { passive: true });
    onTT();
  ...
  (function () {
    ...
    var dots = Array.prototype.slice.call(car.querySelectorAll('.sl-dot'));
    function step() { return cards.length ? cards[0].getBoundingClientRect().width + 12 : 0; }
